...
mortality_table <- read_excel("/Users/sarahkircher/Documents/2024 SOA Case Comp/SOACaseComp2024/full_mortality_table.xlsx")
...
write_xlsx(spwl_middle_premiums, "/Users/sarahkircher/Documents/2024 SOA Case Comp/SOACaseComp2024/spwl_middle_premiums.xlsx")
...
write_xlsx(t20_middle_premiums, "/Users/sarahkircher/Documents/2024 SOA Case Comp/SOACaseComp2024/t20_middle_premiums.xlsx")
...
# Costs
The costs are calculated based on the number of policyholders utilizing the incentives, the frequency of incentive usage, and the one-time cost of each incentive. For the incentive cost calculation, we assume 100% participation, encompassing 978,582 inforce policyholders and 61,740 smokers, across all three offered incentives. The cost amounts for each incentive are determined by averaging the maximum and minimum cost provided in the “Interventions” Excel spreadsheet. The one-time costs for each incentive, rounded to the nearest Lumarian crown, are as follows:
- Mental Health Support: Č218
- Fitness Tracking Watch: Č105
- Smoking Cessation Program: Č2,177

The mental health support is assumed to be utilized once per month for 20 years. The fitness watch incurs a one-time cost, with a physical check-in required once per month for 20 years, costing Č44 per visit. The smoking cessation program is assumed to be attended four times per year for five years, after which the policyholder is no longer considered a smoker.

Mental Health Support: 978,582 * Č218 * 12 months * 20 years = Č51,199,410,240
Fitness Tracking Watch: 978,582 * Č105 = Č102,751,110
Physical Check-In: 978,582 * Č44 * 12 months * 20 years = Č10,333,825,920
Smoking Cessation Program: 61,740 * Č2,177 * 4 months * 5 years = Č2,688,159,600
The total costs amount to Č64,324,146,870.

*Total Costs = Č64,324,146,870 = $36,904,272,444*
...
*Total Middle Premiums = Č97,569,095,167 = $55,977,679,385*
...
*Total Benefits = $-5,358,728,273 = Č9,340,263,381*
...
*PROFIT = $24,506,475,538 = Č42,585,211,678*
...
*Total Rebates = $598,095,007 = Č1,042,479,597*
...
*PROFIT 2 (including rebates) = $23,908,380,531 = Č1,042,479,597*

# Convert to Lumarian Crowns - 1.743 Crowns = 1 US dollar

```{r}
crowns <- 1.743
crowns_total_premiums <- crowns * total_premiums
crowns_total_benefits <- crowns * total_benefits
crowns_total_costs <- crowns * total_costs
crowns_total_rebates <- crowns * total_rebates
crowns_profit <- crowns * profit
crowns_profit2 <- crowns * profit_2

crowns_total_premiums
crowns_total_benefits
crowns_total_costs
crowns_total_rebates
crowns_profit
crowns_profit2
